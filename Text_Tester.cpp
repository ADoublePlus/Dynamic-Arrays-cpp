...
const string Text_Tester::DEL_WORD = "DELETE";

Text_Tester::Text_Tester() : error_(false), funcname_("")
{
...
void Text_Tester::testAppendText()
{
...
void Text_Tester::testDeleteWordAll()
{
...
string* Text_Tester::generateText_(vector<string>& text_vector, unsigned int& length, unsigned int& capacity)
{
    if (capacity == 0)
    {
...
void Text_Tester::generateWord_(string& word, const unsigned int length)
{
...
bool Text_Tester::checkText_(string* text, vector<string>& text_vector, unsigned int length)
{
...
void Text_Tester::errorOut_(const string& errMsg, unsigned int errBit)
{
    cerr << funcname_ << " " << "(fail";
...
void Text_Tester::passOut_(const string& passMsg)
{
    if (!error_)
    {
